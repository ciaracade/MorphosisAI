...
- sike you thought, doing the backend first

## Cool resources I used for this project :)
...
- [ElkJS](https://github.com/kieler/elkjs): Implements an infrastructure to connect diagram editors or viewers to automatic layout algorithms.
